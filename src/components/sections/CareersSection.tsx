  ...
  <section id="careers" className="py-10 bg-pink-100 h-full">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <p className="mb-4 text-lg leading-relaxed">
        At <strong>Articulate Allied Health,</strong> we believe great clinicians thrive when they have the flexibility, support and autonomy to provide genuinely person-centred care.
      </p>
      <p className="mb-4 text-lg leading-relaxed">
        We are always interested in connecting with passionate and experienced <strong>Speech Pathologists and Allied Health professionals</strong> who are looking to work as <strong>subcontractors</strong> within a supportive, collaborative and growing practice.
      </p>
      ...
      <p className="mb-8 text-lg leading-relaxed">
        Whether you are an experienced clinician looking to expand your practice or an established practitioner seeking greater flexibility, <strong>Articulate Allied Health would love to hear from you.</strong>
      </p>
